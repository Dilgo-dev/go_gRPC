...
var file_proto_log_proto_depIdxs = []int32{
	3, // 0: log.LogsResponse.logs:type_name -> log.LogEntry
	0, // 1: log.LogService.CreateLog:input_type -> log.LogRequest
	2, // 2: log.LogService.GetLogs:input_type -> log.EmptyRequest
	1, // 3: log.LogService.CreateLog:output_type -> log.LogResponse
	4, // 4: log.LogService.GetLogs:output_type -> log.LogsResponse
